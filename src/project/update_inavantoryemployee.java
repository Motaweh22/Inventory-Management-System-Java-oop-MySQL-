 ...
 * @author mazen
 */
public class update_inavantoryemployee extends javax.swing.JFrame {

    /**
     * Creates new form update_inavantoryemployee
     */
    public update_inavantoryemployee() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("update Invantory Employee");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        if (evt.getSource() ==  update) {
            try {
                database.InvantoryEmplyee_log_database.update_user(username.getText(), password.getText(),user_id.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(update_inavantoryemployee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new update_inavantoryemployee().setVisible(true);
            }
        });
    }
