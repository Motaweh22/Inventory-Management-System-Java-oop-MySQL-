...
public class admin_log extends javax.swing.JFrame {
    ...
    private void log_inActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_log_inActionPerformed
        ...
        {
            int i=database.admin_log_database.check_user(name_text.getText(),password_text.getText());
            if(i==1){
                JOptionPane.showMessageDialog(null, "hi admin","Succed",JOptionPane.INFORMATION_MESSAGE);
                this.dispose();
                admin ff3=new admin();
