 ...
 * @author mazen
 */
public class update_sellerr extends javax.swing.JFrame {

    /**
     * Creates new form update_sellerr
     */
    public update_sellerr() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("update Seller");

        jLabel2.setText("input id to update");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(user_id, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        if (evt.getSource() ==  update) {
            try {
                database.selle_log_database.update_user(username.getText(), password.getText(),user_id.getText());
                JOptionPane.showMessageDialog(null, "The seller has updated", "Succed", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(update_sellerr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new update_sellerr().setVisible(true);
            }
        });
    }
