 ...
 * @author mazen
 */
public class update_marketingemployeee extends javax.swing.JFrame {

    /**
     * Creates new form update_marketingemployeee
     */
    public update_marketingemployeee() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("update Marketing Employee");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        if (evt.getSource() ==  update) {
            try {
                 database.marketingrmployee_log_database.update_user(username.getText(), password.getText(),user_id.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(update_marketingemployeee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new update_marketingemployeee().setVisible(true);
            }
        });
    }
